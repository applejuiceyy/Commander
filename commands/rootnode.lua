local class = require "commands/class"
local basenode = require "commands/basenode"
local util     = require "commands/util"
local context  = require "commands/context"
local stringreader = require "commands/stringreader"
...
function RootNode:addHelp()
    ...
    self._help = true
    local main = require("commands/main")
    self:append(
        main.literal("help")
        :append(
            main.str("name")
